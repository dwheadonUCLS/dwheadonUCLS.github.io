...
function applyNumColors() {
  ...
  for (var i = 0; i < numColors; i++) {
    ...
    colorTableBody.append('<tr> <td><input disabled onkeyup="editBinR(event);"></input></td><td><input disabled onkeyup="editBinG(event);"></input></td><td><input disabled onkeyup="editBinB(event);"></input></td> <td><input disabled onkeyup="editHexR(event);"></input></td><td><input disabled onkeyup="editHexG(event);"></input></td><td><input disabled onkeyup="editHexB(event);"></input></td><td><input disabled onkeyup="editDecR(event);" onchange="editDecR();"></input></td><td><input disabled onkeyup="editDecG(event);" onchange="editDecG();"></input></td><td><input disabled onkeyup="editDecB(event);" onchange="editDecB();"></input></td><td>'+ (i>0 ? '<span class="diff">&lt;diff</span>' : '')+'</td></tr>');
  }
  $("#promptBase").show();
